...
<head>
    ...
    <title>IDigiSoftBox | Edit Data Mahasiswa</title>
            ...
            <div class="menu">
                ...
                <ul class="menu-links">
                    <div class="dropdownMenu">
                        ...
                        <div class="dropdownMenu-Content">
                            <li class="data"><a href="edit-data.php"><i class='bx bxs-calendar-edit icon'></i>Edit Data Mahasiswa</a> </li>
                                <li class="data"><a href="Searchdata.php"><i class='bx bx-data icon'></i> Data Mahasiswa</a> </li>
                        </div>
                    </div>
                    ...
                    <div class="dropdownMenu">
                        ...
                        <div class="dropdownMenu-Content">
                                <li class="data"><a href="#"><i class='bx bx-data icon'></i> Data Jurusan</a> </li>
                                <li class="data"><a href="#"><i class='bx bxs-calendar-edit icon'></i>Edit Data Jurusan</a> </li>
                        </div>
                    </div>
    ...
    <section class="home">
        ...
        <div class="container-left">
            ...
            <form action="../mahasiswa/_create.php" method="POST">
                <h1 class="text"> <b>Edit <span style="color:#F4A01C ;">Data Mahasiswa</span></b></h1>
                <legend class="text">Edit Biodata Mahasiswa Dengan Benar</legend>
                <hr>
                <div class="row mb-2">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-10">
                        <select class="form-select" aria-label="Default select example" name="kode_jurusan" Required>
                            <?php while ($jurusan = $exec->fetch_assoc()) : ?>
                                <option value="<?= $jurusan['nama'] ?>" <?= $jurusan['nama'] == $jurusan['nama'] ? "selected" : "" ?>><?= $jurusan['kode'] ?></option>
                            <?php endwhile ?>
                        </select>
                    </div>
                </div>
               <fieldset class="row mb-2" Required>
                ...
                <div class="col-sm-10">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="jenis_kelamin" value="perempuan" <?= $data['jenis_kelamin'] == "Permpuan" ? "checked" : "" ?>>
          ...
          <div class="container-left button">
            ...
            <a   class="btn btn-danger" href="edit-data.php">Cancle</a>
          </div>
