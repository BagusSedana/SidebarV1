...
<body>
                ...
                <ul class="menu-links">
                    ...
                    <div class="dropdownMenu">
                        ...
                        <div class="dropdownMenu-Content">
                                ...
                                <li class="data"><a href="#"><i class='bx bx-message-x icon'></i>Hapus Data Jurusan</a> </li>
                        </div>
                    </div>
    ...
    function cari($cariData) {
        include "../koneksi.php";
        $cariData = $_POST['cari'];
        $qry = "SELECT * FROM mahasiswa WHERE nim LIKE '%$cariData%' OR nama_mhs  LIKE '%$cariData%' OR kode_jurusan  LIKE '%$cariData%' OR jenis_kelamin LIKE '%$cariData%' OR no_hp  LIKE '%$cariData%' OR alamat LIKE '%$cariData%' OR email  LIKE '%$cariData%' ";
  ...
  ?>
    ...
    <section class="home">
        ...
        <div class="container-left">
            <!-- Form -->
            <h1 class="text"> <b>Table Cari <span style="color:#F4A01C ;">Data Mahasiswa</span></b></h1>
            <legend class="text">Biodata Mahasiswa</legend>
            <form action="#" method="POST">
                ...
                <input type="text" name="cari" placeholder="Cari Data Mahasiswa">
